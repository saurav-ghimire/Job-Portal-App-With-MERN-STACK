      ...
      <div className="w-[50%] bg-white p-10">
        ...
        <form action="">
          <div className='flex flex-col items-start gap-4'>
            ...
            <Button className='w-full bg-red-700 hover:bg-red-900'>Signup</Button>

          </div>
        </form>
      </div>
      <div>
        <Image src="/images/signup.gif" alt="Signup Animation" width="500" height="600" className='mix-blend-multiply	' />
      </div>
    </div>
  );
}
